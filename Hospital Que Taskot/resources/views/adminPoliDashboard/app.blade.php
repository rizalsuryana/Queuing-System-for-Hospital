...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var dateInput = $('#visitDate2');
    
            // // Fungsi untuk membatasi tanggal maksimal h-1
            // function setMinDate() {
            //     var today = new Date();
            //     // today.setDate(today.getDate()); // Mengurangi satu hari dari tanggal sekarang
            ...
            dateInput2.on('change', setMinDate2);
...
<head>
    @include('adminRegisterDashboard.partials.head')
    <style>
        * p {
            margin-bottom: 0;
        }
...
<body>
<div id="app">
    @include('adminPoliDashboard.partials.header')
    @include('adminPoliDashboard.partials.nav')
    <main id="main" style="min-height: 80vh;">
    @yield('content')
    </main>
    @include('adminPoliDashboard.partials.footer')
</div>
...
<script src="{{asset('vendor/nca/main.js')}}"></script>
